...
VALUES ('Пользователи'), ('Заказы'), ('Доставка'), ('Поставки');

-- Статусы
INSERT INTO dicts.statuses (status_group_id, status_name) VALUES 
(1, 'Новый'), 
(1, 'Подтверждённый'), 
(1, 'Заблокирован'), 
(2, 'Новый'), 
...
-- Категории товаров
INSERT INTO warehouse.categories (category, slug) VALUES
('Кофе', 'coffee'),
('Подарки', 'gifts'),
