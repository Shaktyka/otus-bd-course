...
1. **Категории товаров** (categories)
    ...
    Список категорий товаров. У категории есть название и slug - идентификатор в виде строки, используемый для ссылок.
    ...
    * _slug_ * - слаг
    ...
    Данные справочника используются в таблице связей продуктов с категориями.
...
1. **Товар_категория** (product_category)

    Определяет связь продукта и категорий. У товара может быть несколько категорий, соответственно, в таблице будет несколько записей id товара с разными id категорий.
