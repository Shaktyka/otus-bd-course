...
1. **Пользователи** (users)
    ...
    Хранит данные о пользователях (физлицах): покупателях, представителях поставщиков, сотрудниках и т.п. Адреса доставки хранятся в таблице adresses.
...
1. **История заказов** (order_history)
    ...
    * *dttmend* - дата смены присвоенного статуса
